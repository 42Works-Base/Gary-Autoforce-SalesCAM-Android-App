...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_applyRGBCurve(JNIEnv *env, jclass clazz,
...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_applyChannelCurves(JNIEnv *env,jclass clazz,
...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_doBrightness(JNIEnv *env, jclass clazz,
...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_doContrast(JNIEnv *env, jclass clazz,
...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_doColorOverlay(JNIEnv *env, jclass clazz,
...
JNIEXPORT jintArray
Java_com_autoforcecam_app_photofilters_imageprocessors_NativeImageProcessor_doSaturation(JNIEnv *env, jclass clazz,
